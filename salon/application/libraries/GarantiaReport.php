...
class GarantiaReport extends FPDF {
...
function EndParagraph()
{
  ...
  public function Header()
  {
    if ($this->PageNo()==1) {
      // code...
      $this->Image($this->ary['imagen'],5,5,50);
      $this->SetFont('Arial','B',10);
      $this->Cell(205,10,mb_strtoupper("Certificado de garantía"),0,1,'C',0);
  ...
  public function Footer()
  {
    ...
    $this-> Cell(100, 10, (('Fecha de impresión: ').date('d-m-Y')), 0, 0, 'L');
    $this->Cell(110, 10, ('Página ').$this->PageNo().'/{nb}', 0, 0, 'R');
  }
  ...
  public function getInstance($a,$b,$c){
      return new GarantiaReport($a,$b,$c);
  }
