    ...
    function get_data(){
        ...
        if ($row != 0) {
            ...
            foreach ($row as $rows) {
                ...
                $menudrop .= "<li><a  data-toggle='modal' data-target='#viewModal' data-refresh='true'  role='button' class='modal_edit_porcentaje' data-id=".$rows->id_porcentaje."><i class='mdi mdi-square-edit-outline' ></i> Editar</a></li>";
                $state = $rows->activo;
                if($state==1){
                    $txt = "Desactivar";
