                ...
                <div class="ibox-content">
                    <form name="formulario" id="formulario" novalidate="novalidate">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6"><label class="text-dark font-bold" for="">Dirección</label>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <label class="text-dark font-bold" for="">Teléfono</label>
                                <input name="telefono" id="telefono" class="form-control tel" placeholder="Ingrese el teléfono de la empresa" value="<?= $telefono_empresa ?>" type="text">
                            </div>
                            <div class="form-group col-lg-4"><label class="text-dark font-bold" for="">Correo electrónico</label>
                            ...
                            <div class="form-group col-lg-4"><label class="text-dark font-bold" for="">Página Web</label>
