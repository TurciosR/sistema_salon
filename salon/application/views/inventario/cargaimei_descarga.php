    ...
    <div class="col-lg-12">
      <div class="ibox" id="main_view">
        <div class="ibox-title">
          <h3 class="text-success"><b><i class="mdi mdi-plus"></i>Descarga de IMEI's</b></h3>
        </div>
                 ...
                 <?php for ($i=0; $i < $key->cantidad; $i++) {
                   ...
                   <div class="col-lg-4 dat">
                     <div class="form-group single-line">
                       ...
                       <?php
                       for ($w=0; $w < $key->n_imei; $w++) {
                          $spC = "co".($j+1);
                        ?>
                       <input id_producto='<?=$key->id_producto ?>' id_detalle='<?=$key->id_detalle ?>' chain='<?=$chain?>' c='<?=$j+1?>' required data-parsley-trigger="change" type='text' placeholder="IMEI" class='form-control text-right imei <?=$spC?>' value='' >
                     <?php $j++; }?>
                     </div>
                   </div>
                 <?php } ?>
