          ...
          <form id="form_edit_des" novalidate>
            ...
            <div class="row">
              ...
              <div class="form-actions col-sm-3">
                <input type="hidden" name="sucursal" value="<?=$row->id_sucursal?>">
                    ...
                    <tbody id="table_producto">
                      <?php foreach ($detalles as $key): ?>
                        <tr>
                				...
                				<td><?= $key->precios ?></td>
                				<td><input <?= $key->validar ?> type='text' class='form-control subtotald' readonly value='<?=$key->subtotal ?>' style='width:100%;'></td>
