...
<div class="modal-header">
  ...
  <div class="col-lg-11">
    <h4 class="modal-title">Editar % descuento cliente</h4>
...
<div class="modal-body">
    ...
    <form id="form_edit" data-parsley-validate>
        ...
        <input type="hidden" name="id_porcentaje" value="<?=$row->id_clasifica?>">
    </form>
</div>
<div class="modal-footer">
    <button type="button" class="btn btn-white" data-dismiss="modal">Cerrar</button>
    <button type="submit" form="form_edit" class="btn btn-primary" id="btn_edit" >Guardar</button>
</div>
<script>
    $(".numeric").numeric({
        negative: false,
