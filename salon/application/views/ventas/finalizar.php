      ...
      <div class="ibox" id="main_view">
        <div class="ibox-title">
          <h3 class="text-success font-weight-bold">
            <i class="mdi mdi-plus"></i> Finalizar pre-venta
          </h3>
        </div>
                  ...
                  <table class="table-striped">
                    ...
                    <tbody id="table_producto">
                      ...
                      <?php foreach ($detalles as $key):
                        ...
                        <td><input type='hidden' class='color' value='<?=$key->id_color ?>'><input type='hidden' class='stock' value='<?=$key->stock ?>' style='width:100%;'><?=$key->stock ?></td>
