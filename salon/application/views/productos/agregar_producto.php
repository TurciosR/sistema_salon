          ...
          <form id="form_add" novalidate>
            ...
            <div class="col-lg-3">
              <div class="form-group single-line">
                ...
                placeholder="Ingrese un modelo o Descripción"
                required data-parsley-trigger="change">
              </div>
            </div>
            <div class="col-lg-3">
                ...
                <table class="table table-striperd table-hover table-bordered">
                  ...
                  <tbody id="precios">
                    ...
                    foreach ($precios as $row_por)
                    {
                      ...
                      $lista .= "<td style='text-align: right' class='td_porcentaje'><input type='text' class='form-control porcentaje_td' id='porcentaje_td' name='porcentaje_td' value='".number_format($resultado2,2)."'></td>";
