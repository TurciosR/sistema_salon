    ...
    <div class="col-lg-12">
      <div class="ibox" id="main_view">
        <div class="ibox-title">
          <h3 class="text-success"><b><i class="mdi mdi-plus"></i> Corte de caja.</b>&nbsp;&nbsp;<label>Con usuario : <?=$usuario->nombre?></label></h3>
        </div>
        <div class="ibox-content">
          ...
          <form id="form_corte_caja" novalidate>
              ...
              <div class="row">
                ...
                <div class="col-lg-6 ">
                  <div class="form-group single-line">
                    ...
                    <input type="text" name="fecha" id="fecha" class="form-control mayu"
                    value="<?=date("d-m-Y")?>"
                    readonly>
                  </div>
                </div>
                ...
                <div class="col-lg-6">
                 ...
                 <table class="table table-border">
                  ...
                  <tbody id='tabla_doc'>
                    <tr>
                      <td>TIQUETE</td>
                      <td><input type="hidden" id="t_min" name="t_min" value="<?=	$ticket_rowmm_efectivo->minimo?>"><?php if(	$ticket_rowmm_efectivo!==NULL){ echo 	$ticket_rowmm_efectivo->minimo;} ?></td>
                      <td><input type="hidden" id="t_max" name="t_max" value="<?=	$ticket_rowmm_efectivo->maximo?>"><?php if(	$ticket_rowmm_efectivo!==NULL){ echo	$ticket_rowmm_efectivo->maximo;} ?></td>
                    ...
                    <tr>
                      ...
                      <td>FACTURA</td>
                      <td><input type="hidden" id="cof_min" name="cof_min" value="<?=	$cof_rowmm_efectivo->minimo?>"><?php if(	$cof_rowmm_efectivo!==NULL){ echo $cof_rowmm_efectivo->minimo;} ?></td>
                      <td><input type="hidden" id="cof_max" name="cof_max" value="<?=	$cof_rowmm_efectivo->maximo?>"><?php if(	$cof_rowmm_efectivo!==NULL){ echo $cof_rowmm_efectivo->maximo;} ?></td>
                    ...
                    <tr>
                      ...
                      <td><input type="hidden" id="ccf_min" name="ccf_min" value="<?=$ccf_rowmm_efectivo->minimo?>"><?php if($ccf_rowmm_efectivo!==NULL){ echo $ccf_rowmm_efectivo->minimo;} ?></td>
                      <td><input type="hidden" id="ccf_max" name="ccf_max" value="<?=$ccf_rowmm_efectivo->maximo?>"><?php if($ccf_rowmm_efectivo!==NULL){ echo $ccf_rowmm_efectivo->maximo;} ?></td>
                    ...
                    <tr>
                      <td>(-RETENCION)</td>
                        <td></td><td></td><td></td>
                      <td><input type="hidden" id="total_retencion" name="total_retencion" value="<?=$total_row_ret->retencion?>"><label id="id_totalre"><?php if($total_row_ret!==NULL){ echo number_format($total_row_ret->retencion,2,".",",");} ?></label></td>
                    </tr>
                    <tr>
                      <td>TOTAL</td>
                        <td></td><td></td><td></td>
            ...
            <table class="table table-border" id="table_dev" >
              ...
              <tbody id="tabla_devs">
                ...
                <?php endif; ?>
                  ...
                  <td class="text-right"><input type="hidden" id="total_dev" name="total_dev" value="<?=$total_row_dev->total;?>"><label id="id_total_dev"><?php if($total_row_dev!==NULL){ echo number_format($total_row_dev->total,2,".",",");} ?></label></td>
                </tr>
              </tbody>
            </table>
            </div>
            ...
            <div class="col-lg-6" id="caja_nc">
                <div class="form-group single-line">
              <div class='alert alert-success text-center' style='font-weight: bold;'>
                <label style='font-size: 15px;'>Total Notas de Crédito</label>
              </div>
            ...
            <table class="table table-border" id="table_nc" >
              ...
              <tbody>
                  <td colspan="4">TOTAL</td>
                  <td class="text-right"><label id="id_total_nc"><?php $monto_nc=0.0;echo number_format($monto_nc,2,".","");?></label></td>
                </tr>
              </tbody>
            </table>
            </div>
          ...
          <table class="table table-border" id="table_dev" >
              ...
              <tbody id="table_data">
                <tr>
                  ...
                  <td style="text-align: center">
                    <label id="id_total_general"><?php echo number_format(($total_efectivo_fin + $total_entrada_caja + $total_abonos_cuentas_cobrar - ($total_salida_caja+$total_row_dev->total)),2,".","");?></label></td>
                    <td style="text-align: center">
            ...
            <div class="row">
              ...
              <div class="form-actions col-lg-12">
                ...
                <button type="submit" id="btn_corte_caja" name="btn_corte_caja"
