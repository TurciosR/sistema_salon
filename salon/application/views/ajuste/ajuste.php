    ...
    <div class="col-lg-12">
      <div class="ibox" id="main_view">
        <div class="ibox-title">
          <h3 class="text-success"><b><i class="mdi mdi-plus"></i> Ajuste de inventario</b></h3>
        </div>
        <div class="ibox-content">
          <form id="form_add" novalidate>
            ...
            <div class="row">
              ...
              <div class="col-lg-3">
                <div class="form-group">
                  <select data-parsley-trigger="change" style="width:100%" required class="select2" name="sucursal" id="sucursal">
