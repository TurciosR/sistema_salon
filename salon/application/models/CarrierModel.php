...
class CarrierModel extends CI_Model
{
	...
	function get_collection($order, $search, $valid_columns, $length, $start, $dir,$id_sucursal)
	{
		...
		// $this->db->select("v.requiere_imei,v.imei_ingresado,v.id_venta,DATE_FORMAT(v.fecha,'%d-%m-%Y') as fecha, FORMAT(v.total,2) as total, v.guia, c.nombre, e.descripcion");
